...
from .views import all_issues, get_issue, delete_issue, add_issue, edit_issue, add_solution, edit_solution, teams_cocurrics_issues,academic_issues, admin_dealing_issues, miscellaneous_issues, hostels_issues, upvotes, solved_issues

urlpatterns = [
    url(r'^all/$', all_issues, name = "all"),
    url(r'^solved/$', solved_issues, name = "solved"),
